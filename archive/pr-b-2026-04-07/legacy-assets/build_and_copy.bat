...
cd /d "C:\Users\r.marks\OneDrive - Financial Reporting Council\Desktop\balloon-render\frontend"
...
cd /d "C:\Users\r.marks\OneDrive - Financial Reporting Council\Desktop\balloon-render"
